...
**Note:** You can also set per-document headers / footers using [YAML Front Matter][yaml], after enabled “Read and overwrite export settings from YAML front matters” option in the Settings panel under Export -> PDF. Sample YAML front matters is like:
